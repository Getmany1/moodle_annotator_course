...
parent_dir = os.path.join('moodle_quiz') # name of folder which will contain the collected data
html_temp_fname = 'template.html' # html template file for rater quiz
rater_quiz_xml_fname = 'testquiz2.xml' # filename of the xml quiz file generated by the script
...
if STAGE2:
    ...
    for f in glob.glob(parent_dir+'/**/*.ogg', recursive=True):
        ...
        generate_quiz_xml(txt, task, ques_var, user, "http://digitalamoodle.aalto.fi/digi_rsrc"+wav_path[2:], task_prompt, question_prompt, quiz)
