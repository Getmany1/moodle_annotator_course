...
rater_quiz_xml_fname = 'testquiz3.xml' # filename of the xml quiz file generated by the script
...
if STAGE2:
    ...
    for f in glob.glob(parent_dir+'/**/*.ogg', recursive=True):
        ...
        generate_quiz_xml(txt, task, ques_var, user, "http://digitalamoodle.aalto.fi/digi_rsrc/"+wav_path, task_prompt, question_prompt, quiz)
